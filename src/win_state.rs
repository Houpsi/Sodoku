...
impl Win {
    pub fn new(window: &mut PistonWindow)-> Self {
        Self {
            ...
            texture_win: Texture::from_path(&mut window.create_texture_context(), "assets/images/game-over.png",  Flip::None, &TextureSettings::new(),).expect(" Download failed : game-over."),
        }
    }
